...
OUTPUT_REPO = "P2SAMAPA/p2-etf-tda-macro-filtration-results"
...
# TDA parameters
BASE_MAX_DISTANCE = 0.6      # baseline Rips filtration distance
MAX_DIMENSION = 1            # compute Betti-0 and Betti-1
TOP_N = 3
